...
<?php //var_dump($current); ?>
        <form action="<?=base_url()?>index.php/search" method="GET">
            <div class="row-fluid">
                <div class="span4">
                    <input type="text" name="id" value="<?=$current['id'] ? $current['id'] : '';?>" placeholder="รหัสนิสิต"><br>
                    <input type="text" name="name" value="<?=$current['name'] ? $current['name'] : '';?>" placeholder="ชื่อ นามสกุล">
                </div>
                <div class="span4">
            ...
            <div>
                <input type="checkbox" class="rowfilter" id="mark1" name="mark1" value="1"<?=isset($current['mark1']) ? ' checked' : ''?>> ขาดวันที่ 1
                <input type="checkbox" class="rowfilter" id="mark2" name="mark2" value="2"<?=isset($current['mark2']) ? ' checked' : ''?>> ขาดวันที่ 2
